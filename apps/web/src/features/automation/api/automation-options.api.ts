...
export async function getAutomationCampaignOptions() {
...
export async function getAutomationAdAccountOptions() {
  const response = await apiClient.get("/ad-accounts", {
    params: { page: 1, limit: 100, isActive: true, sortBy: "updatedAt", sortOrder: "desc" },
  });
